...
def firstMove(self, view):
    ...
    if view[2][1][1] < nScouts/8:
        ...
        return (Actions.MOVE_W, Actions.DROP_NONE)
    
    # Check NW
    elif view[1][1][1] < nScouts/8:
        self.job = Jobs.SCOUT
        self.jobRegion = JobRegions.NW
        return (Actions.MOVE_NW, Actions.DROP_NONE)
